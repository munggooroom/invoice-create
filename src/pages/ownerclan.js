...
const excelFile = xlsx.readFile('src/common/오너클랜.xlsx');
...
const jsonParser = (array) => {
    ...
    jsonData.map(v => {
        ...
        newList.push('오) '+v.상품명); //상품명
        newList.push(v.옵션); //옵션
        ...
        newList.push(v.받는사람); //주문자
        newList.push(v.받는사람전화번호 || 받는사람핸드폰); //주문자전화
        newList.push(v.받는사람핸드폰 || 받는사람전화번호); //주문자핸드폰
        newList.push('') //주문자이메일
        newList.push(v.받는사람); //수령자
        newList.push(v.받는사람전화번호 || 받는사람핸드폰); //전화
        newList.push(v.받는사람핸드폰 || 받는사람전화번호); //핸드폰
        newList.push('') //수령자영문이름
        newList.push('') //수령자주민등록번호(통관용)
        newList.push(v.우편번호); //우편번호
        newList.push(v.주소); //주소
        newList.push(v.배송메세지); //배송메세지
        newList.push('') //배송사명
        newList.push('') //송장번호
        newList.push('') //사은품
...
//시트 생성
xlsx.utils.book_append_sheet(list, orders, '오너클랜송장');

//엑셀 파일 생성
xlsx.writeFile(list, '오너클랜송장.xlsx');